...
{
  return cx_bn_is_locked() ? CX_OK : CX_NOT_LOCKED;
}

cx_err_t cx_bn_unlocked(void)
{
  return cx_bn_is_unlocked() ? CX_OK : CX_NOT_UNLOCKED;
}
                              ...
                              size_t nbytes)
{
  ...
  CX_CHECK(cx_bn_init(*bn_x, bytes, nbytes));
end:
  return error;
}
...
cx_err_t cx_bn_rng(cx_bn_t bn_r, const cx_bn_t bn_n)
{
  cx_err_t error;
  cx_mpi_t *r, *n;
...
cx_err_t cx_bn_shr(cx_bn_t bn_r, uint32_t n)
{
  cx_err_t error;
  cx_mpi_t *r;
...
cx_err_t cx_bn_shl(cx_bn_t bn_r, uint32_t n)
{
  cx_err_t error;
  cx_mpi_t *r;
...
cx_err_t cx_bn_xor(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b;
...
cx_err_t cx_bn_or(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b;
...
cx_err_t cx_bn_and(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b;
...
cx_err_t cx_bn_add(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b;
...
cx_err_t cx_bn_sub(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b;
...
cx_err_t cx_bn_mul(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b;
...
cx_err_t cx_bn_mod_add(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b,
                           const cx_bn_t bn_m)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b, *m;
...
cx_err_t cx_bn_mod_sub(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b,
                           const cx_bn_t bn_m)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b, *m;
...
cx_err_t cx_bn_mod_mul(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b,
                           const cx_bn_t bn_m)
{
  cx_err_t error;
  cx_mpi_t *r, *a, *b, *m;
...
cx_err_t cx_bn_mod_pow(cx_bn_t bn_r, const cx_bn_t bn_a,
                           ...
                           const cx_bn_t bn_n)
{
  ...
  CX_CHECK(cx_bn_alloc_init(&bn_e, cx_get_bn_size(), bytes_e, len_e));
...
cx_err_t cx_bn_mod_pow2(cx_bn_t bn_r, const cx_bn_t bn_a,
                            const uint8_t *bytes_e, uint32_t len_e,
                            const cx_bn_t bn_n)
{
  return cx_bn_mod_pow(bn_r, bn_a, bytes_e, len_e, bn_n);
}
